...
class FriendshipSerializer(serializers.ModelSerializer):
    ...
    def get_fields(self) -> Dict[str, serializers.Field]:
        ...
        fields = OrderedDict([
            ...
            ('addressee_first_name', serializers.CharField(source='addressee.first_name', read_only=True)),
            ('addressee_last_name', serializers.CharField(source='addressee.last_name', read_only=True)),
